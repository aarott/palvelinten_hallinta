...
Ajan kolme idempotenttia komentoa verkon yli molemmalle orja-koneelle. (tiedosto, weppipalvelin Apache2 ja käyttäjä).  
...
## h) h) Hello, IaC. Tee infraa koodina kirjoittamalla /srv/salt/hello/init.sls. Aja tila jollekin orjalle. Tila voi esimerkiksi tehdä esimerkkitiedoston johonkin hakemistoon. Testaa toisella komennolla, että pyytämäsi muutos on todella tehty.  
