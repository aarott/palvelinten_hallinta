...
Yksinkertaisesti menin "vahingossa" poistamaan winter.md tiedoston. Sen jälkeen `git reset --hard` komennon muutos on tuhottu ja kuten näkyy, winter.md tiedosto on ilmestynyt takaisin. 
