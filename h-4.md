...
Vinkeissä oli lisätä tähän tuo service- watch, jotta demoni käynnistetään uudelleen, jos asetustiedosto muuttuu masterilla. Muokkaan siis vikaa osaa näyttämään tältä:
